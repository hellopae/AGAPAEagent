...
**มีรูปแล้ว 2 คน:** `claudy` · `minnie` — เปิดใช้ในเว็บเรียบร้อย
ที่เหลืออีก 11 คนยังใช้หัว avatar เดิมไปก่อน: `reese · addy · rae · vera · mind · chris · libby · nick · dale · toby · news`
...
> ✅ **พื้นหลังโปร่งใสแล้ว** — ไฟล์ที่ส่งมามี alpha ครบ ใช้ได้เลย
> ตอน gen ให้สั่ง "transparent background, PNG with alpha" ต่อไปเรื่อย ๆ
>
> ส่งไฟล์ดิบมาได้เลยไม่ต้องแต่ง — ผมจะตัดขอบโปร่งให้เท้าชิดขอบล่างพอดี
> ย่อให้สูงเท่ากันทุกตัว (512px) และลดจำนวนสีให้ไฟล์เล็กลงครึ่งนึงก่อนเอาขึ้นเว็บ
> ไฟล์ดิบเก็บไว้คู่กันในโฟลเดอร์เดียวกัน (`Claudy-SD.png`, `Minni-SD.png`)
