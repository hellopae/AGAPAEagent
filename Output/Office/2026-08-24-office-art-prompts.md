...
**มีรูปแล้ว 4 คน:** `claudy` · `minnie` · `reese` · `addy` — เปิดใช้ในเว็บเรียบร้อย (ทั้งในผังออฟฟิศและแถวเอเจนต์เหนือผัง)
เหลืออีก 9 คน: `rae · vera · mind · chris · libby · nick · dale · toby · news`

ในแถวเอเจนต์ ใครยังไม่มีตัว SD จะใช้รูปการ์ดเต็มกรอบสี่เหลี่ยม (เล็งกลางใบหน้าด้วยค่าเดียวกับการ์ดด้านล่าง)
ใครมีตัว SD แล้วจะยืนเต็มความสูงกรอบบนพื้นอ่อน — ดูปุ๊บรู้เลยว่าเหลือใครยังไม่ได้ gen
