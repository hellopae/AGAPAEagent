...
**มีรูปแล้ว 3 คน:** `claudy` · `minnie` · `reese` — เปิดใช้ในเว็บเรียบร้อย (ทั้งในผังออฟฟิศและแถวเอเจนต์เหนือผัง)
เหลืออีก 10 คน: `addy · rae · vera · mind · chris · libby · nick · dale · toby · news`
